const STORAGE_KEY = 'pain-jigsaw-anchor-builder-v1';
const PIECE_W = 186;
const PIECE_H = 154;
const TAB = 28;
...
function renderSelectedPanel(){
  ...
  if(piece.href){learnMoreLink.hidden=false;learnMoreLink.href=`${piece.href}?return=builder`;}else learnMoreLink.hidden=true;
}
